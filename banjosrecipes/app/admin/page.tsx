...
export default function AdminPage() {
 ...
 return <main className="container adminPage"><Link className="back" href="/recipes"><Icon name="back"/> Back to the collection</Link><p className="eyebrow">FOR THE COOK BEHIND THE COLLECTION</p><h1>Chef’s desk.</h1><p className="intro">One pick, shared with everyone. Only the owner can change it.</p>
