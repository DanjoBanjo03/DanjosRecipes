...
const categories = ["All recipes", "Mains", "Soups", "Sauces & sides", "Desserts", "Meal prep"]
...
export default function Home() {
  ...
  return <main className="container">
    ...
    </section><aside className="notebookNote"><Icon className="notebookIcon"/><div><h3>A notebook that grows with you.</h3><p>These recipes come from your Food recipes collection. Missing details have been filled in with practical suggestions. Choose how many people you’re cooking for in each recipe.</p></div></aside>
  </main>
}
